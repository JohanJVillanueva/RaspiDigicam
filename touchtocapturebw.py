...
# Function to give a "film look" to the image and make it black and white
...
def capture_screenshot(frame):
    ...
    # Apply the film look effect (black and white)
    edited_frame = apply_film_look(cropped_frame)

    # Save the edited image to a file
    filename = '/home/dsp/Pictures/%03d_film_bw.jpg' % frame
    cv2.imwrite(filename, edited_frame)
    print('Black-and-white image captured and edited: ' + filename)
